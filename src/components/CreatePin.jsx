...
const CreatePin = ({user}) => {
  ...
  return (
    <div className='createPin-wrapper flex flex-col justify-center items-center mt-5 lg:h4/5'>
      {fields && (
              ...
              <label>
                <div className="flex flex-col items-center justify-center h-full">
                  ...
                  <p className="mt-32 text-gray-400">
                    Recommendation: Use high-quality JPG, JPEG, SVG, PNG, or GIF less than 20MB
                  </p>
                </div>
                <input
                  type="file"
