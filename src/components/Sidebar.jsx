...
const Sidebar = ({user, closeToggle}) => {
  ...
  return (
    <nav className='sidebar-nav flex flex-col justify-between bg-white h-full overflow-y-scroll min-w-210 hide-scrollbar'>
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-5">
          ...
          {categories
            .slice(0, categories.length - 1) //remove last item (other)
            .map(category => (
              <NavLink 
